      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
          ...
          <div className="py-1">
            ...
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m2-4h-6a2 2 0 000 4h6a2 2 0 000-4z" />
              </svg>
              Wallet
            </Link>
            {user.canAccessAdmin && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-3">
              ...
              />
              <span className="text-xl font-bold text-gray-900 dark:text-white hidden sm:block">WeRgame</span>
            </Link>
