/** ITU calling codes for E.164 / Twilio SMS (one row per country). */
...
export function isoToFlag(iso) {
  ...
  return s.replace(/./g, (ch) => String.fromCodePoint(127397 + ch.charCodeAt(0)));
}
...
export const COUNTRY_DIAL_CODES = [
  ...
  { iso: 'BV', name: "Bouvet Island", dial: '0055' },
  ...
  { iso: 'FJ', name: "Fiji Islands", dial: '679' },
  ...
  { iso: 'HK', name: "Hong Kong S.A.R.", dial: '852' },
  ...
  { iso: 'MO', name: "Macau S.A.R.", dial: '853' },
  ...
  { iso: 'IM', name: "Man (Isle of)", dial: '44' },
  ...
  { iso: 'PS', name: "Palestinian Territory Occupied", dial: '970' },
  { iso: 'PA', name: "Panama", dial: '507' },
  { iso: 'PG', name: "Papua New Guinea", dial: '675' },
  { iso: 'PY', name: "Paraguay", dial: '595' },
  { iso: 'PE', name: "Peru", dial: '51' },
  { iso: 'PH', name: "Philippines", dial: '63' },
  { iso: 'PN', name: "Pitcairn Island", dial: '870' },
  ...
  { iso: 'MF', name: "Saint-Martin (French part)", dial: '590' },
  ...
  { iso: 'SX', name: "Sint Maarten (Dutch part)", dial: '1721' },
  ...
  { iso: 'SJ', name: "Svalbard and Jan Mayen Islands", dial: '47' },
  ...
  { iso: 'BS', name: "The Bahamas", dial: '1' },
  ...
  { iso: 'VA', name: "Vatican City State (Holy See)", dial: '379' },
  { iso: 'VE', name: "Venezuela", dial: '58' },
  { iso: 'VN', name: "Vietnam", dial: '84' },
  { iso: 'VG', name: "Virgin Islands (British)", dial: '1' },
  { iso: 'VI', name: "Virgin Islands (US)", dial: '1' },
  { iso: 'WF', name: "Wallis and Futuna Islands", dial: '681' },
