            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm opacity-90 mt-2">
                  {(userStreak.correctPredictions ?? 0).toLocaleString()} correct predictions on the platform
                </p>
                      ...
                      >
                        ...
                        <div className="text-center">
                          <div className="text-4xl font-bold text-orange-500 mb-2">
                            🔥 {streakUser.currentStreak ?? streakUser.streak ?? 0}
                          </div>
                          <div className="text-sm text-gray-600 dark:text-gray-400">
                            {(streakUser.correctPredictions ?? 0).toLocaleString()} correct predictions
                          </div>
                          <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            Longest streak: {(streakUser.longestStreak ?? 0).toLocaleString()}
                          </div>
                        </div>
                      </div>
                    );
